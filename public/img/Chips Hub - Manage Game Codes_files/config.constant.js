...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //*** CryptoJS
        'cryptojs': ['vendor/CryptoJS/rollups/aes.js'],

        //*** Chips Controllers
        'GameCodeCtrl': 'chips/controllers/gamecodeCtrl.js',
        'BookersCtrl': 'chips/controllers/bookersCtrl.js',
        'TableCtrl': 'chips/controllers/ngTableCtrl.js',
        'dashboardCtrl':'chips/controllers/dashboardCtrl.js',
        'invoicesCtrl': 'chips/controllers/invoicesCtrl.js',
        'loginCtrl': 'chips/controllers/loginCtrl.js',
        'agentCtrl': 'chips/controllers/agentCtrl.js',
        'usersCtrl': 'chips/controllers/usersCtrl.js',
        'userCtrl': ['chips/controllers/userCtrl.js'],

        //*** Chips directives
        'cnxGamecodes': 'chips/directives/cnxGamecodes.js',
        'cnxUser': 'chips/directives/cnxUser.js',
        'cnxInvoice': 'chips/directives/cnxInvoice.js',
        'autoFill': 'chips/directives/autoFill.js',
    ...
    modules: [{
        ...
        name: 'ngDialog',
        files: ['vendor/ngDialog/js/ngDialog.js', 'vendor/ngDialog/css/ngDialog.css', 'vendor/ngDialog/css/ngDialog-theme-default.css', 'vendor/ngDialog/css/ngDialog-theme-plain.css', 'vendor/ngDialog/css/ngDialog-custom-width.css']
    }]
});
